...
Several methods were attempted to resolve issues with movement. One such solution was to have the farmer restrain the cattle's head whilst the photographs are being taken. 

One such method suggested was to restrain the cattle using a 'crush'.
