...
\newcommand{\hmwkTitle}{Tracing and identifying cattle} % Assignment title
\newcommand{\hmwkDate}{Monday, January 9th 2017} % Due date
\newcommand{\hmwkAuthorNameFirst}{Frederick Lindsey, Thomas Szyszko}
\newcommand{\hmwkAuthorNameSecond}{Karim Nahas, Hongjiang Liu, Gregoire Yharrassarry}
...
\author{
	\textbf{\hmwkAuthorNameFirst} \\
	\textbf{\hmwkAuthorNameSecond}
}
